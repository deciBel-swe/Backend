...
-- USERS
-- =====================================
INSERT INTO users (id, username, display_name, bio, location, avatar_url, cover_photo_url, tier, is_private, show_history, follower_count, following_count, track_count, created_at, updated_at) VALUES
(1, 'djmike', 'DJ Mike', 'Electronic music producer from NYC', 'New York, USA', 'https://i.pravatar.cc/300?u=djmike', NULL, 'FREE', false, true, 150, 75, 5, NOW() - INTERVAL '6 months', NOW()),
(2, 'sarahbeats', 'Sarah Beats', 'Lo-fi hip hop beats to relax/study to', 'Los Angeles, USA', 'https://i.pravatar.cc/300?u=sarahbeats', NULL, 'PRO', false, true, 320, 120, 12, NOW() - INTERVAL '1 year', NOW()),
(3, 'rocknroll99', 'Rock N Roll', 'Classic rock enthusiast and cover artist', 'London, UK', 'https://i.pravatar.cc/300?u=rocknroll99', NULL, 'FREE', false, true, 89, 45, 3, NOW() - INTERVAL '3 months', NOW()),
(4, 'jazzlover', 'Jazz Lover', 'Smooth jazz and saxophone covers', 'Paris, France', 'https://i.pravatar.cc/300?u=jazzlover', NULL, 'PRO', false, true, 210, 98, 8, NOW() - INTERVAL '8 months', NOW()),
(5, 'indieartist', 'Indie Artist', 'Independent musician exploring new sounds', 'Berlin, Germany', 'https://i.pravatar.cc/300?u=indieartist', NULL, 'FREE', true, true, 56, 67, 2, NOW() - INTERVAL '2 months', NOW());
...
(1, 1, 'djmike@example.com', '$2a$10$N9qo8uLOickgx2ZMRZoMyeIjZAgcfl7p92ldGxad68LJZdL17lhWy', 'LOCAL', NULL, 'PASSWORD', true),
(2, 2, 'sarah@example.com', '$2a$10$N9qo8uLOickgx2ZMRZoMyeIjZAgcfl7p92ldGxad68LJZdL17lhWy', 'LOCAL', NULL, 'PASSWORD', true),
(3, 3, 'rock99@example.com', '$2a$10$N9qo8uLOickgx2ZMRZoMyeIjZAgcfl7p92ldGxad68LJZdL17lhWy', 'LOCAL', NULL, 'PASSWORD', true),
(4, 4, 'jazz@example.com', '$2a$10$N9qo8uLOickgx2ZMRZoMyeIjZAgcfl7p92ldGxad68LJZdL17lhWy', 'LOCAL', NULL, 'PASSWORD', true),
(5, 5, 'indie@example.com', '$2a$10$N9qo8uLOickgx2ZMRZoMyeIjZAgcfl7p92ldGxad68LJZdL17lhWy', 'LOCAL', NULL, 'PASSWORD', true);
...
(1, 'admin', 'admin@decibel.com', '$2a$10$N9qo8uLOickgx2ZMRZoMyeIjZAgcfl7p92ldGxad68LJZdL17lhWy', 'https://i.pravatar.cc/300?u=admin', 'Chrome on Windows');
...
-- =====================================
-- PLAYLIST SLUGS - Table doesn't exist in current schema
-- =====================================
-- Skipped: playlist_slugs table not present
...
-- =====================================
-- USER PROFILE TOKENS (for sharing)
-- =====================================
...
-- SELECT setval('playlist_slugs_id_seq', (SELECT MAX(id) FROM playlist_slugs)); -- Table doesn't exist
...
SELECT
    ...
    (SELECT COUNT(*) FROM track_likes) AS likes;
